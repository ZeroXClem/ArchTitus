...
# because mkinitcpio writes the new image before dropping the old and needs
# transient headroom on top of the total. linux + linux-lts + linux-cachyos is
# a normal outcome of the prompts in startup.sh, so size for it.
